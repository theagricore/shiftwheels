  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final double carouselHeight = isWeb ? 240 : 170;
        final double viewportFraction = isWeb ? 0.35 : 0.88;
        final double titleFontSize = isWeb ? 16 : 20;
        final double badgeFontSize = isWeb ? 10 : 12;
                    ...
                    child: ClipRRect(
                      ...
                      child: Stack(
                        ...
                        children: [
                          ...
                          // PREMIUM badge on top-right corner of card
                          Positioned(
                            top: 16,
                            right: 16,
                            child: Container(
